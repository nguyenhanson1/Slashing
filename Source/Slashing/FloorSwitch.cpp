...
void AFloorSwitch::BeginPlay()
{
	...
	UE_LOG(LogTemp, Warning, TEXT("%s"), *InitialDoorLocation.ToString());
...
{
	UE_LOG(LogTemp, Warning, TEXT("Component Begin Overlapping"));
...
{
	UE_LOG(LogTemp, Warning, TEXT("Component End Overlapping"));
